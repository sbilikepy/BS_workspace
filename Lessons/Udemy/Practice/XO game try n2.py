...
game_field = (f"{cell_pares['cell_1']} | "  # FIELD VISUAL
              f"{cell_pares['cell_2']} | " \
              f"{cell_pares['cell_3']} \n" \
              f"{cell_pares['cell_4']} | " \
              f"{cell_pares['cell_5']} | " \
...
print(f"Hello! Lets play tic-tac-toe.\n"  # MAIN PART
...
while turn_counter_from > 1:  # LOGIC
    while game_over == 0:
        if {cell_pares['cell_1']} == {cell_pares['cell_2']} == {cell_pares['cell_3']}:  # WIN CONDITION
        ...
        if game_over == 0:  # INPUT PART
            ...
            for key, value in cell_pares.items():
                if player_choose == value:
                    ...
                    print(f"__________________________________________________")
                    game_field = f"{cell_pares['cell_1']} | " \
                                 f"{cell_pares['cell_2']} | " \
                                 f"{cell_pares['cell_3']} \n" \
                                 f"{cell_pares['cell_4']} | " \
                                 f"{cell_pares['cell_5']} | " \
