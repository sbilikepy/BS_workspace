...
print(
    "___static methods creation example___"
)  # when no atributes, just method collection
...
class Date:
    ...
    @classmethod
    def millenium_classmethod(
        cls, month, day
    ):  # self is instantion and cls is info about class
        return cls(month, day, 2000)

    @staticmethod
    def millenium_staticmethod(
        month, day
    ):  # self is instantion and cls is info about class
